...
## Крок 3. Use Case Diagram (Діаграма прецедентів)
```mermaid
flowchart LR
...
## Крок 4. Class Diagram (Діаграма класів)
```mermaid
classDiagram
...
## Крок 5. Sequence Diagram (Діаграма послідовності)
```mermaid
sequenceDiagram
    autonumber
...
```
## Крок 6. Traceability Matrix (Матриця трасовності)
